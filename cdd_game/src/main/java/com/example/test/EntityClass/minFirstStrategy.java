...
public class minFirstStrategy extends AIStrategy {
    public minFirstStrategy(){
        super();
    }
    public minFirstStrategy(GameRule gameRule){super(gameRule);}
    @Override
    public void Strategy(int number) {//策略1：从当前牌中选择最小的出          //修改为只传序号
